              ...
              {transcripts.length === 0 ? (
                ...
                transcripts.map((t) => (
                  <div key={t.id} className={`flex ${t.sender === 'user' ? 'justify-end' : 'justify-start'}`}>
                    <div
                      dir="auto"
                      className={`max-w-[85%] rounded-2xl px-4 py-3 shadow-sm ${t.sender === 'user'
        ...
        <div className="flex items-center justify-between max-w-xs mx-auto">
          ...
          <div className="flex flex-col items-center space-y-2">
            <button
              ...
              className={`w-14 h-14 rounded-full flex items-center justify-center transition-all ${showTranscript
